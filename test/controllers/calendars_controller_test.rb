...
class CalendarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calendar" do
    assert_difference("Calendar.count") do
      post calendars_url, params: { calendar: { content: @calendar.content, name: @calendar.name, title: @calendar.title } }
    end
  ...
  test "should update calendar" do
    patch calendar_url(@calendar), params: { calendar: { content: @calendar.content, name: @calendar.name, title: @calendar.title } }
